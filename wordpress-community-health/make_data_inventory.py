    ...
    <section class="section">
      ...
      <div class="commands">
        ...
        <div class="command">
          ...
          <code>cp data_inventory.html make_data_inventory.py project_load.html make_project_load_report.py market_position.html make_market_position_report.py developer_interest.html make_developer_interest_report.py job_demand.html make_job_demand_report.py support_load.html make_support_load_report.py contributor_depth.html make_contributor_depth_report.py ecosystem_activity.html make_ecosystem_activity_report.py source_gap_plan.html make_source_gap_plan.py goal_audit.html make_goal_audit.py refresh_report_artifacts.py /Users/admin/sqlite-database-integration-pages/wordpress-community-health/</code>
        </div>
      </div>
    </section>
