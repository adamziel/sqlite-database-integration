...
def main():
    ...
    timeline = "".join(
        [
            ...
            timeline_item("Adoption", "Added W3Techs, HTTP Archive, BuiltWith, WordPress.org stats, Stack Overflow, Wikimedia, autocomplete query-intent snapshots, Hacker News hiring threads, Remote OK current jobs, WordPress Jobs snapshots, compact new-site summaries, and attention/demand proxy summaries."),
    ...
    coverage_grid = coverage_cards(
        [
            ...
            ("Community outside tickets", "Release credits, committers, Make/Core, WordCamp, Events, Translate, Five for the Future, support snapshots and answer summaries, plugin/theme directory, stale popular plugins, and enterprise case studies.", "Covered with snapshots"),
...
{card("Database", compact(table_count), "tables", "SQLite stores imported ticket data, fetched ecosystem data, npm package downloads, source hashes, generated summaries, and known source gaps.", "green", 92)}
...
{card("Known gaps", compact(partial_gaps), f"of {compact(source_gaps)} partial", "Remaining ideal sources are true new-site history, search-provider data, broad hiring demand, longer support history, and another developer-community source.", "amber", 35)}
    </section>
