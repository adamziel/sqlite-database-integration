...
def main():
    ...
    coverage_grid = coverage_cards(
        [
            ...
            ("Community outside tickets", "Release credits, committers, Make/Core, WordCamp, Events, Translate, Five for the Future, support snapshots and answer summaries, plugin/theme directory, plugin search breadth, stale popular plugins, and enterprise case studies.", "Covered with snapshots"),
