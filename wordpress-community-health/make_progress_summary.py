...
GAP_SUMMARIES = {
    ...
    "job_demand": {
        "title": "Hiring demand",
        "current": "HN hiring threads, Remote OK and Remotive current jobs, and annual plus quarterly WordPress Jobs board snapshots are in.",
...
def main():
    ...
    link_cards = "".join(
        [
            ...
            link_card("Market position", "Installed-share, current new-site proxy, runtime context, and demand direction readout.", "market_position.html", "amber"),
            ...
            link_card("Job demand", "HN hiring mentions, Remote OK and Remotive current jobs, quarterly WordPress Jobs snapshots, and jobs-board categories.", "job_demand.html", "amber"),
