...
PLAN = {
    ...
    "developer_interest_proxy": {
        ...
        "order": "5",
        "color": "violet",
        "next_step": "Keep Stack Overflow, Wikimedia, npm package downloads, GitHub PR activity, and GitHub review-comment activity, then add another developer-community source if available.",
